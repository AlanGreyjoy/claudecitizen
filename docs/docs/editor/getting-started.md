...
2. **Build the scene** — Hierarchy shows GameObjects; drag GLBs from Project or add boxes/empties. Add `game-manager`, `planet`, `player-start`, and `prefab-instance` components to decide what the scene is.
