...
Values can also be overridden by server-side ship definitions in the [Server console](/server-console/ship-definitions). Prefab stats serve as defaults when no catalog override exists.
