...
Prop definitions in the [Server console](/server-console/prop-definitions) link catalog rows to these prefab ids.
...
Item definitions in the [Server console](/server-console/item-definitions) reference item prefab ids when a 3D representation is needed.
