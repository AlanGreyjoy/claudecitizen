...
Drag an audio file from the Project panel onto the inspector field, or paste the asset URL (e.g. `/assets/free/sfx/door-creak.ogg`). Store files under `assets/free/sfx/` or `src/assets/sfx/`.
