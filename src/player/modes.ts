...
export const MODE_ENTERING_CHAIR: GameMode = 'entering-chair';
export const MODE_IN_CHAIR: GameMode = 'in-chair';
export const MODE_LEAVING_CHAIR: GameMode = 'leaving-chair';
...
export const CHAIR_SIT_TRANSITION_SECONDS = 1.3;
export const CHAIR_STAND_TRANSITION_SECONDS = 1.0;
...
export function isChairOccupancyMode(mode: GameMode): boolean {
  return (
...
export function modeLabel(mode: GameMode): string {
  switch (mode) {
    ...
    case MODE_LEAVING_BED:
      return 'Getting Up';
    case MODE_ENTERING_CHAIR:
      return 'Sitting Down';
    case MODE_IN_CHAIR:
      return 'Seated';
    case MODE_LEAVING_CHAIR:
      return 'Standing Up';
